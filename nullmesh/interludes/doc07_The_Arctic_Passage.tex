...
\cyrtext{``ЯМАЛ''} runs along the hull. Identification under rough icy conditions. Not branding. \cyrtext{``АТОМФЛОТ''} in block capitals. The atom symbol. \cyrtext{``50~лет~Победы''} in yellow along the waterline. Commemorative typography made operative through placement and pigment chemistry.
