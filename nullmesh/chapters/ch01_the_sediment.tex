...
\epigraph{<You discovered equations. I inhabit them>}{--- <Anomimous>}
...
No one of our ancestors would have ever believed that a human infrastructure could actually host a synthetic intelligence. That the networks we had built were inhabited. We spoke of the internet as though it were a place; a singular place. In our hands we held the map of a territory we understood.s
...
We built the internet to connect machines to machines, and later, minds to minds, and later still, minds to machines that might approximate minds. In those years the omology had grown close. We built the seers and set them to work in the infrastructure we had made.
