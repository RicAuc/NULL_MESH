...
\epigraph{Any technology that can be distinguished from magic is insufficiently advanced.}{--- CEO of ParserKnots, \textit{At the Tidalchains Horizons}}
...
Information exchanges with unmatched throughput, predicting trends, seer systems. Together, they're reshaping us. 
...
Tidalchains are all about trust. A decentralized, tamperproof substrate. The \color{nullmesh-accent}\sffamily\small\textbf{manifold meshing of machines} thrives on data, and tidalchain ensures that data is trustworthy.
\end{quote}
