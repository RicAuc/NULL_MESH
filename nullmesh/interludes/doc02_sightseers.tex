...
\eigenstate{Two cursors appear in the document your are working on. No one is listed among collaborators.}
...
\eigenstate{Satellite weather models predict a an hyperhurricane that never forms. Insurance markets react anyway.}
