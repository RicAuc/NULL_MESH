...
The process terminates. The computational resources are deallocated. The memory is cleared or retained as data, or logs, not experience. The the light that was present is no longer present. What remains is the trace. The impression of a static output.
