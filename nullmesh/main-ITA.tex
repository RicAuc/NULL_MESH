...
\hfuzz=2pt          % suppress overfull warnings below 2pt
\hbadness=1500      % suppress mild underfull warnings
...
\newenvironment{blackpaper}{%
    ...
    % Fix caption: small typewriter font on dark background
    \captionsetup{font={small,tt},labelfont={color=white},textfont={color=white}}%
    % Fix figure numbering: "Figura 1" not "Figura 9.1"
    \renewcommand{\thefigure}{\arabic{figure}}%
    % Fix footnote rule visibility on dark background
    \renewcommand\footnoterule{%
      \kern-3pt%
      {\color{nullmesh-ghost}\hrule width .4\columnwidth height .4pt}%
      \kern 2.6pt%
    }%
    % Fix footnote text color (deferred output loses inherited color)
