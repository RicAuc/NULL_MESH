...
The web was built on attention harvesting. The mesh will increasingly be deepen. The web will shrink. The folk is increasingly accessing the mesh through ersatz without surfing themselves.

But autonomous processes that can search and execute tasks without human oversight are about to upend this completely.
