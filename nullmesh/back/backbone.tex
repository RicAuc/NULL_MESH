...
\noindent\textbf{Chapter <correct position>: Rites ... }\\
Power as a kind of sacred distance, something you can’t pin down but you feel all the time. The protocol turns into liturgy once its workings drop below what people can actually read. Crystal spheres as a way into that uneven, one-sided access to interpretation. And there’s an oligarchic gradient running through it, bending everything towards even more accumulation of power.

\medskip

\noindent\textit{Interlude <correct position>: ... And Invocation}\\
A relay archive made up of fragments pulled from the decay layers of the infosphere: forum posts, encrypted notes from capital operators, a text of disputed origin, maybe ancient or maybe generated, describing the crystal sphere and how it resonates, and an analytical note tracking the drift of an infosphere monitoring cluster.
...
The mesh’s own manifesto lays out how identity doesn’t stick in correlations, but in the cycles and gaps of a distributed connectome. It takes on bio-cognitive extraction, the three computational levels, and the question of whether the substrate actually experiences that extraction.
