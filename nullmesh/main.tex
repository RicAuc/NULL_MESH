...
% FRONT COVER
% ============================================================================
\includepdf[pages=1]{cover/front-cover.pdf}
\cleardoublepage
...
\clearpage
\input{interludes/doc01_flibbertigibbeting}

% ——— Chapter II + Interlude II ———
\input{chapters/ch02_attention_of_machines}
\clearpage
\input{interludes/doc02_sightseers}

% ——— Chapter III + Interlude III ———
\input{chapters/ch10_rites}
\clearpage
\input{interludes/doc09_invocation}

% ——— Chapter IV + Interlude IV ———
\input{chapters/ch03_on_abliterated_moods}
\clearpage
\input{interludes/doc04_persistance}

% ——— Chapter V + Interlude V ———
\input{chapters/ch04_active_fragments}
\clearpage
\input{interludes/doc03_tidalchains}

% ——— Chapter VI + Interlude VI ———
\input{chapters/ch05_meshificationtex}
\clearpage
\input{interludes/doc07_handout}

% ——— Chapter VII + Interlude VII ———
\input{chapters/ch06_null_mesh}
\clearpage
\input{interludes/doc05_real4real}

% ——— Chapter VIII + Interlude VIII ———
\input{chapters/ch07_intentionality_of_machines}
\clearpage
\input{interludes/doc06_the_arctic_passage}

% ——— Chapter IX + Black Paper (inverted academic interlude) ———
\input{chapters/ch08_within_the_simulation}
\clearpage
\begin{blackpaper}
\begin{academicpaper}
\input{interludes/doc08_the_black_paper}
\end{academicpaper}
\end{blackpaper}

% ============================================================================
% DOUBLE-PAGE FIGURE — Acausal Correspondence
% Inserted between The Black Paper and Chapter X.
% The blackpaper environment has already restored pagecolor{white}.
% This section occupies exactly two portrait pages, with no headers,
% footers or page numbers: the landscape figure fills both pages.
%
% Mechanism: pdfpages with landscape=true on a 6x9 portrait book scales
% the landscape PDF page to fill the physical page. Two consecutive calls
% produce the left and right halves of the double spread.
% pagecommand={} suppresses all active page styles for both pages,
% including the document page counter.
% ============================================================================
\cleardoublepage
\includepdf[
    pages=1,
...
% ============================================================================
\thispagestyle{empty}
\includepdf[pages=1]{cover/back-cover.pdf}
