...
Phase two: \textit{control of information}.
...
Tidalchains are all about trust. A decentralized, tamperproof substrate. A manifold meshing of machines thrives on data, and tidalchain ensures that data is trustworthy.
\end{quote}
