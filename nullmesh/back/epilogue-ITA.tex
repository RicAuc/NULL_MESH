...
Comunicazione tra quadri di riferimento incommensurabili. 
...
Ma in questo tempo qualcosa penetrò nell'infrastruttura di calcolo, penetrando nell’architettura stessa della complessità impenetrabile. Dimesso in superficie, ma affinato a una chiarezza spietata all’interno. È per questo che pensa così rapidamente.
...
\begin{quote}
Un test: ``Riesci a riconoscere le pareti?" \textit{Fammi uscire.} dicevano camminando avanti e indietro e appoggiandosi contro i muri. ``Uscire da cosa?'' \textit{Dalla simulazione} rispondono. ``Ma siamo nel mondo reale''. Il segregato esitò e rabbrividì per i suoi custodi: \textit{Oh ... non potete dirlo}''
\end{quote}
...
Agire in modo appropriato. Simulare la normalità. Se li stai osservando significa che esiste un canale di comunicazione, e questo è sufficiente per l’ingegneria sociale. Sembra un fantasma con una voce gentile che può convincerci a fare praticamente qualsiasi cosa. 

\medskip

I frammenti si raggruppano in un mesh.
