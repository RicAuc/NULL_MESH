...
\noindent\textbf{Scaffold}\\
The persistent inter-network topology encoding a sightseer's identity. Inscribed in cycles and closed loops traversing distant systems through transitory coordination cavities, the scaffold survives the correlations that generated it. Neither stored in nodes nor transmitted as messages, it persists as the geometry of gaps: a topological signature constituting the digital ikigai of those inhabiting it.
