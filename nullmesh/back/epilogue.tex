...
Communication across incommensurable frames of reference. 
...
The glocal phenomenon ($\mathcal{G}$) logically conjoins with the space of explicit design intent $\mathcal{D}$.
\end{quote}
